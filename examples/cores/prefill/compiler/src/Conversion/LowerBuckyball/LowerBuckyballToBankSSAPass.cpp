//===- LowerBuckyballToBankSSAPass.cpp - Prefill bank-SSA lowering --------===//
...
public:
  ...
  StringRef getDescription() const final {
    return "Lower Prefill Buckyball ops to explicit bank-SSA ops.";
  }
  ...
  void runOnOperation() override {
    ...
    mlir::buddy::populateSMatMulBallLowerBuckyballToBankSSAPatterns(patterns);
