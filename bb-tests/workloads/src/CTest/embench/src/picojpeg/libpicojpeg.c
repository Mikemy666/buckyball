...
#define PJPG_DESCALE(x)                                                        \
  PJPG_ARITH_SHIFT_RIGHT_N_16(((x) + (1U << (PJPG_DCT_SCALE_BITS - 1))),       \
                              PJPG_DCT_SCALE_BITS)
...
const uint8 gWinogradQuant[] = {
    128, 178, 178, 167, 246, 167, 151, 232, 232, 151, 128, 209, 219,
    209, 128, 101, 178, 197, 197, 178, 101, 69,  139, 167, 177, 167,
